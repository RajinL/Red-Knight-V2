...
public class CameraFollow : MonoBehaviour
{
    ...
    [SerializeField] public bool rushStarted;
    [SerializeField] public bool rushEnded;
    ...
    void Awake()
    {
        if (GameObject.FindGameObjectWithTag("rush_object"))
        {
            rushObject = GameObject.FindGameObjectWithTag("rush_object");
        }
    ...
    private void SetObjToFollowReference()
    {
    ...
    /// </summary>
    /// if the camera is hitting the bat wasll
    //private void OnTriggerEnter2D(Collider2D collision)
    //{
    //    if (startOfRush != null && collision.gameObject == GameObject.FindGameObjectWithTag("rush_object"))
    //    {
    //        Debug.Log("Collided with rush start");
    //        rushStarted = true;
    //    }
    //}
...
//    [SerializeField] private GameObject objToFollow;
//    [Tooltip("The rush object the camera will follow.")]
//    [SerializeField] private GameObject rushObject;
//    [Header("Rush Settings")]
//    [Tooltip("The collider 2D with trigger that dictates when to trigger the rush scene when the camera collides with it." +
//        "Leave blank if the scene does not have a rush.")]
//    [SerializeField] private Collider2D startOfRush;
//    [Tooltip("The collider 2D with trigger that dictates when to stop the rush scene when the camera collides with it.")]
//    [SerializeField] private Collider2D endOfRush;
//    [Tooltip("The time it takes for the camera to switch between having the object it is following in the middle and on the" +
//        "left side of the screen.")]
//    [SerializeField] float transitionDuration = 2.5f;
//    [Tooltip("A boolean to dictate if the rush has started.")]
...
//            objToFollow = GameObject.FindGameObjectWithTag("rush_object");
//        }
//        else objToFollow = GameManager.instance.player;
...
//    {
//        Debug.Log("Collided with rush start");
//        if (startOfRush != null && collision.gameObject == rushObject)
//        {
//            rushStarted = true;
//        }
//        //if (endOfRush != null && collision.gameObject == endOfRush)
//        //{
//        //    Debug.Log("Collided with rush end");
//        //    rushStarted = false;
//        //    rushObject.SetActive(false);
//        //    objToFollow = GameManager.instance.player;      
//        //}
//        //startOfRush.gameObject.SetActive(false);
//    }
